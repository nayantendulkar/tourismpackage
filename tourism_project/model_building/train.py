...
numeric_features = ["Age", "DurationOfPitch","NumberOfTrips","MonthlyIncome"]
categorical_features = ["TypeofContact","CityTier","Occupation","Gender","NumberOfPersonVisiting","NumberOfFollowups","ProductPitched",

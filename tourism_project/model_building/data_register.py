...
# To understand the datatypes of different columns, use "info" method
print(df.info())
# To find out statistical summary of data, use "describe" method and take it's transpose for better visualization
print(df.describe().T)
